...
class MyPreferenceFragment : PreferenceFragmentCompat(),
    ...
    private lateinit var isLoveMuPreference: androidx.preference.CheckBoxPreference
    ...
    private fun init() {
        ...
        isLoveMuPreference =
            findPreference<androidx.preference.CheckBoxPreference>(LOVE) as androidx.preference.CheckBoxPreference
    }
