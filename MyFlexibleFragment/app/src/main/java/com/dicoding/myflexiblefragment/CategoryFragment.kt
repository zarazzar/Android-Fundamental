...
class CategoryFragment : Fragment(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val btnDetailCategory: Button = view.findViewById(R.id.btn_detailCategory)
        btnDetailCategory.setOnClickListener(this)
    }

    override fun onClick(v: View) {
        if (v.id == R.id.btn_detailCategory){
            val detailCategoryFragment = DetailCategoryFragment()

            val bundle = Bundle()
            bundle.putString(DetailCategoryFragment.EXTRA_NAME,"LifeStyleee")
            val description = "Kategoriii ini akan berisi produk-produk lifestyle"
