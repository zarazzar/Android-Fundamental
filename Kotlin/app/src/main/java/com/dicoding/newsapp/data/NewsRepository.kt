...
class NewsRepository private constructor(
    ...
    //mediatorLiveData digunakan untuk menggabungkan banyak sumber data dalam liveData
    ...
    //create function to take bookmark
    fun getBookmarkedNews(): LiveData<List<NewsEntity>> {
        return newsDao.getBookmarkedNews()
    }

    fun setBookmaredNews(news: NewsEntity, bookmarkState: Boolean) {
        appExecutors.diskIO.execute{
